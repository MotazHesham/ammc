        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.founderInfo.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.founder-infos.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('title_1') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title_1" id="title_1" value="{{ old('title_1', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('title_2') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title_2" id="title_2" value="{{ old('title_2', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('national') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="national" id="national" value="{{ old('national', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('dob') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="dob" id="dob" value="{{ old('dob', '') }}" required>
                            @if($errors->has('dob'))
