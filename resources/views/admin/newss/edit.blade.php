                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.newss.update", [$news->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $news->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group {{ $errors->has('date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="date" id="date" value="{{ old('date', $news->date) }}" required>
                            @if($errors->has('date'))
                        ...
                        <div class="form-group {{ $errors->has('short_description') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="short_description" id="short_description" value="{{ old('short_description', $news->short_description) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('long_description') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="long_description" id="long_description" required>{{ old('long_description', $news->long_description) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\News::STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $news->status) === (string) $key ? 'checked' : '' }}>
