    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.aboutuses.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('about_us_1') ? 'is-invalid' : '' }}" name="about_us_1" id="about_us_1" required>{{ old('about_us_1') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('about_us_2') ? 'is-invalid' : '' }}" name="about_us_2" id="about_us_2" required>{{ old('about_us_2') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('about_us_3') ? 'is-invalid' : '' }}" name="about_us_3" id="about_us_3" required>{{ old('about_us_3') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('client_text') ? 'is-invalid' : '' }}" name="client_text" id="client_text" required>{{ old('client_text') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('success_text') ? 'is-invalid' : '' }}" name="success_text" id="success_text" required>{{ old('success_text') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('task_text') ? 'is-invalid' : '' }}" name="task_text" id="task_text" required>{{ old('task_text') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('time') ? 'is-invalid' : '' }}" name="time" id="time" required>{{ old('time') }}</textarea>
                @if($errors->has('time'))
                    <div class="invalid-feedback">
                        {{ $errors->first('time') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('manager_name') ? 'is-invalid' : '' }}" type="text" name="manager_name" id="manager_name" value="{{ old('manager_name', '') }}" required>
