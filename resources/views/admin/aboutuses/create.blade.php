                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.aboutuses.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('about_us_1') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="about_us_1" id="about_us_1" required>{{ old('about_us_1') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('about_us_2') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="about_us_2" id="about_us_2" required>{{ old('about_us_2') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('about_us_3') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="about_us_3" id="about_us_3" required>{{ old('about_us_3') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('client_text') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="client_text" id="client_text" required>{{ old('client_text') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('success_text') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="success_text" id="success_text" required>{{ old('success_text') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('task_text') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="task_text" id="task_text" required>{{ old('task_text') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('email_1') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="email" name="email_1" id="email_1" value="{{ old('email_1') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('phone_1') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone_1" id="phone_1" value="{{ old('phone_1', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('time') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="time" id="time" required>{{ old('time') }}</textarea>
                            @if($errors->has('time'))
                        ...
                        <div class="form-group {{ $errors->has('instegram') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="instegram" id="instegram" value="{{ old('instegram', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('contact_text') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="contact_text" id="contact_text" required>{{ old('contact_text') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('manager_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="manager_name" id="manager_name" value="{{ old('manager_name', '') }}" required>
